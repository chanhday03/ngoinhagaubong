...
<body>
    ...
    <section id="sidebar">
        <a href="#" class="brand">
            ...
            <span class="text">TeddyShop</span>
        </a>
    ...
    <section id="content">
      ...
      if(isset($_POST["btn_admin"])){
        ...
        echo'
        <a href="#" class="profile">
        <img src="https://i.pinimg.com/564x/40/47/d8/4047d8532e84e46750ce34c32fedb984.jpg">
        </a>
        ';
      }
