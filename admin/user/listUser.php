                ...
                <div class="">
                    ...
                    <form action="" method="POST" onsubmit="return confirmDesactiv()">
                        <div class="mb-3">
                            ...
                            <input class="user_id form-control" type="text" name="code_cart" value="" required=""
                                autocomplete="off" onkeyup="user_id()" placeholder="Code Cart">
                        </div>
                        <div>
                            <div class="mb-3">
                                <label class="form-label">Người dùng</label>
                                <input type="radio" class=" form-control user_role" name="user_role" value=""
                        ...
                        <button type="submit" name="capNhatVaiTro" value="capNhatVaiTro" class="btn">Cập nhật Vai Trò
                            Người Dùng</button>
