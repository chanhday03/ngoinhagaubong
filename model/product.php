...
{
    $sql = "UPDATE product SET category_id='$iddm' , productName='$tensp', productDesc='$motasp' , productPrice=$giasp , productSize='$sizesp',productPromotion='$khuyenmai' ,productImage='$hinh'WHERE id=" . $id;
    pdo_execute($sql);
}
