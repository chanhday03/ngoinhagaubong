...
function load_ten_dm($iddm){
    if($iddm > 0 ) {
        $sql = "SELECT * FROM category WHERE category_id=".$iddm;
...
function update_product($id, $iddm,$tensp,$motasp,$soluongsp,$giasp,$sizesp,$hinh){
        $sql = "UPDATE product SET category_id='$iddm' , productName='$tensp', productDesc='$motasp' , productCount='$soluongsp', productPrice='$giasp'  , productSize='$sizesp',productImage='$hinh'   WHERE id=".$id;
    pdo_execute($sql);
}
