...
:root {
    --brown-color: #905219;
    --light-brown-color: #a68567;
    --orange-color: #ff8000;
    --light-orange-color: #ee936c6c;
    --text-color: #1a2428;
    --bg-color: #fff;
...
.categories-container .box:nth-child(even) {
    background-color: #fef4ea;
}

.categories-container .box:nth-child(odd) {
...
.products-container .box .fa-heart:hover {
    color: tomato;
    transform: scale(1.5);
}
...
.customers-container .box .fa-quote-left {
    font-size: 24px;
    color: var(--brown-color);
}

.customers-container .box .stars .fa-star {
    font-size: 10px;
    color: var(--light-orange-color);
}
...
.footer-box form .fa-envelope:hover {
    color: var(--orange-color);
}
...
<body>
    ...
    <div class="note">
        <div class="ship">
            <img src="./images/note_ship.jpg" alt="">
            <p>GIAO HÀNG TẬN NHÀ</p>
        </div>
        <div class="gift">
            <img src="./images/note_gift.jpg" alt="">
            <p>GÓI QUÀ SIÊU ĐẸP</p>
        </div>
        <div class="ship">
            <img src="./images/note_wash.jpg" alt="">
            <p>CÁCH GIẶT GẤU BÔNG</p>
        </div>
        <div class="ship">
            <img src="./images/note_help.jpg" alt="">
